      ...
      <section className="px-6 py-20 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={index}
              className="group bg-[#25304f] rounded-2xl shadow-md hover:shadow-2xl hover:scale-105 transition-all duration-300 p-8 text-center hover:cursor-pointer"
            >
              <h3 className="text-xl font-semibold mb-4 text-[#cfd2d6] group-hover:text-white transition-colors">
                {step.title}
              </h3>
              <p className="text-[#cfd2d6] group-hover:text-white transition-colors">
                {step.desc}
              </p>
            </div>
          ))}
      ...
      <section className="px-6 py-20 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="group bg-[#25304f] rounded-2xl shadow-md hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center h-80 hover:cursor-pointer"
            >
